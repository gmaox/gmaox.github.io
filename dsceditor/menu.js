...

{
    ...
    const menuitem_rmtargets1 = document.getElementById('menuitem_rmtargets1');
    menuitem_rmtargets1.oncontextmenu = menuitem_rmtargets1.onclick = function () { remove_targets1(); }
